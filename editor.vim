...
wincmd w
argglobal
if bufexists("Script/Helpers.js") | buffer Script/Helpers.js | else | edit Script/Helpers.js | endif
if &buftype ==# 'terminal'
  silent file Script/Helpers.js
endif
balt Script/main.js
setlocal fdm=manual
setlocal fde=0
...
exe 'vert 2resize ' . ((&columns * 141 + 141) / 283)
tabnext 1
badd +44 Script/main.js
badd +21 Script/Helpers.js
