...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 139 + 141) / 283)
exe 'vert 2resize ' . ((&columns * 143 + 141) / 283)
argglobal
...
63
normal! zc
let s:l = 169 - ((154 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 169
...
exe 'vert 2resize ' . ((&columns * 141 + 141) / 283)
tabnext 1
badd +2 Script/Game/Run.js
badd +0 index.html
badd +1 Script/Game/Objects.js
badd +164 Script/Game/Sections.js
badd +60 Script/Game/Helpers.js
